...
type ExampleAppSpec struct {
	...
	// EnableTracing adds a tracing sidecar to the application.
	EnableTracing bool `json:"enableTracing"`

	// EnableMetrics adds a metrics sidecar to the application.
...
// DeepCopyObject is a dummy implementation for ExampleApp.
...
// DeepCopyObject is a dummy implementation for ExampleAppList.
