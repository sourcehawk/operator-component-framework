...
var _ = Describe("PVC Primitive", Label("pvc"), func() {
	...
	Context("Updates", func() {
		It("should propagate label changes on re-reconciliation", func() {
			...
			framework.UpdateClusterTestApp(ctx, k8sClient, name, func(a *framework.ClusterTestApp) {
				...
				a.Annotations["e2e.ocf.io/trigger"] = "update-labels"
			})
	...
	Context("Guards", func() {
		It("should report Blocked condition when guard blocks", func() {
			clusterReconciler.RegisterResource(name, func(owner *framework.ClusterTestApp) (component.Resource, error) {
				obj := newBasePVC(ns, "guarded-pvc", "1Gi")
				return pvc.NewBuilder(obj).
					WithGuard(func(_ corev1.PersistentVolumeClaim) (concepts.GuardStatusWithReason, error) {
