...
// Resource is a high-level abstraction for managing a Kubernetes Role within
...
type Resource struct {
	base *generic.StaticResource[*rbacv1.Role, *Mutator]
}

// Identity returns a unique identifier for the Role in the format
// "rbac.authorization.k8s.io/v1/Role/<namespace>/<name>".
