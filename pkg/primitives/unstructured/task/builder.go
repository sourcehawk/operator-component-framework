...
// data extractors. Unlike typed task primitives, no default handlers are
// registered. The converging status handler is required; all other handlers
...
func NewBuilder(obj *uns.Unstructured) *Builder {
	...
	base := generic.NewTaskBuilder[*uns.Unstructured, *unstruct.Mutator](
		obj,
		placeholder,
		unstruct.NewMutator,
	)
...
// has completed. This handler is required.
