...
// state to the existing Role in the cluster.
//
...
func (b *Builder) WithCustomFieldApplicator(
	applicator func(current, desired *rbacv1.Role) error,
) *Builder {
...
func (b *Builder) WithFieldApplicationFlavor(flavor FieldApplicationFlavor) *Builder {
	b.base.WithFieldApplicationFlavor(generic.FieldApplicationFlavor[*rbacv1.Role](flavor))
	return b
}
