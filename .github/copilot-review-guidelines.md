...
- If you suspect something might be an issue, first do a quick verification pass (search, read surrounding code, check docs/tests). Only raise a comment when you can point to a specific, evidenced concern, or clearly frame it as a question when you do not have enough evidence.