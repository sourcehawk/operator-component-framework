...
import (
	...
	"github.com/sourcehawk/operator-component-framework/examples/cronjob-primitive/resources"
...
func main() {
	...
	controller := &app.ExampleController{
		...
		// Pass the cronjob resource factory.
		NewCronJobResource: resources.NewCronJobResource,
	}
