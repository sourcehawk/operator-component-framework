...
func DefaultFieldApplicator(current, desired *corev1.ConfigMap) error {
	*current = *desired.DeepCopy()
	return nil
}

// Resource is a high-level abstraction for managing a Kubernetes ConfigMap within
...
type Resource struct {
	base *generic.StaticResource[*corev1.ConfigMap, *Mutator]
}

// Identity returns a unique identifier for the ConfigMap in the format
// "v1/ConfigMap/<namespace>/<name>".
func (r *Resource) Identity() string {
	return r.base.Identity()
}

// Object returns a deep copy of the underlying Kubernetes ConfigMap object.
//
