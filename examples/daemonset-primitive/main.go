...
import (
	...
	"github.com/sourcehawk/operator-component-framework/examples/daemonset-primitive/resources"
...
func main() {
	...
	controller := &app.ExampleController{
		...
		// Pass the daemonset resource factory.
		NewDaemonSetResource: resources.NewDaemonSetResource,
	}
