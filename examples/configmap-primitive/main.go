...
import (
	...
	"github.com/sourcehawk/operator-component-framework/examples/configmap-primitive/app"
	"github.com/sourcehawk/operator-component-framework/examples/configmap-primitive/resources"
...
func main() {
	...
	//    MergeYAML composes config sections from independent feature mutations.
