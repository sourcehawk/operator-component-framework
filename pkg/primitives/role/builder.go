...
// WithMutation registers one or more mutations for the Role.
//
...
// WithMetricsIdentifier sets the Role's identifier for
...
// labelled `role`. Build rejects a blank identifier.
