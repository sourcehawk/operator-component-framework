...
import (
	...
	"github.com/sourcehawk/operator-component-framework/examples/replicaset-primitive/resources"
...
func main() {
	...
	controller := &app.ExampleController{
		...
		// Pass the replicaset resource factory.
		NewReplicaSetResource: resources.NewReplicaSetResource,
	}
