...
import (
	...
	"github.com/sourcehawk/operator-component-framework/examples/ingress-primitive/resources"
...
func main() {
	...
	owner := &app.ExampleApp{
		Spec: app.ExampleAppSpec{
			Version:       "1.2.3",
			EnableTracing: true, // Used as TLS toggle in this example
			EnableMetrics: false,
			Suspended:     false,
		},
	}
	...
	controller := &app.ExampleController{
		...
		// Pass the ingress resource factory.
		NewIngressResource: resources.NewIngressResource,
	}
	...
	specs := []app.ExampleAppSpec{
		{
			Version:       "1.2.3",
			EnableTracing: true, // TLS enabled
			Suspended:     false,
		},
		{
		...
		{
			Version:       "1.2.4",
			EnableTracing: false, // Disable TLS
			Suspended:     false,
		},
		{
			Version:       "1.2.4",
