...
This example demonstrates the usage of the `secret` primitive within the operator component framework.
It shows how to manage a Kubernetes Secret as a component of a larger application, utilising features like:
