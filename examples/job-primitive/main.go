...
import (
	...
	"github.com/sourcehawk/operator-component-framework/examples/job-primitive/resources"
...
func main() {
	...
	if err := batchv1.AddToScheme(scheme); err != nil {
		fmt.Fprintf(os.Stderr, "failed to add batch/v1 to scheme: %v\n", err)
		os.Exit(1)
	}
	...
	controller := &app.ExampleController{
		...
		// Pass the job resource factory.
		NewJobResource: resources.NewJobResource,
	}
	...
	specs := []app.ExampleAppSpec{
		...
		},
		{
			Version:       "1.2.4",
			EnableTracing: false,
			Suspended:     true, // Suspend the job
		},
	}
