...
type ExampleController struct {
	...
	// NewConfigMapResource is a factory function to create the configmap resource.
	// This allows us to inject the resource construction logic.
	NewConfigMapResource func(*sharedapp.ExampleApp) (component.Resource, error)
}
...
func (r *ExampleController) Reconcile(ctx context.Context, owner *sharedapp.ExampleApp) error {
	// 1. Build the configmap resource for this owner.
	cmResource, err := r.NewConfigMapResource(owner)
	if err != nil {
		return err
	}

	// 2. Build the component that manages the configmap.
