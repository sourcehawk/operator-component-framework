...
// PV resource would be registered with SkipOwnerRef to avoid the controller-runtime
// restriction that cluster-scoped resources cannot have namespace-scoped owners.
//
